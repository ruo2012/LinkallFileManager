...
{
    public abstract class DbHelperFileContentSQL
    {
        ...
        public static bool Exists(string strSql,string conn, params SqlParameter[] cmdParms)
        {
            object obj = DbHelperSQL.GetSingle(strSql,conn, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        /// <param name="SQLString">计算查询结果语句</param>
        /// <returns>查询结果（object）</returns>
        public static object GetSingle(string SQLString, string conn, params SqlParameter[] cmdParms)
        {
