...
namespace FileManager.Bll
{
    ...
    public class SystemBll
    {
        ...
        private static string _rootForderPath =  System.AppDomain.CurrentDomain.BaseDirectory;
        ...
        /// <param name="userName"></param>
        /// <returns></returns>
        public static Model.UserModel GetUserInfo(string userName)
        {
            _userInfo = new ManagerBll().GetModel(userName);
            return _userInfo;
        }
        ...
        public static void SystemCheck()
        {
            ...
            string fileContentConn = string.Format("server={0};uid={1};pwd={2};database={3};Connection Timeout=150;", config.DbFileContentAddress, config.DbFileContentUser, config.DbFileContentPassword, config.DbFileContentName);
        ...
        public static void ActionLogAsyn(int projectId, string projectName, string clientPath, ActionType action)
        {
            ...
            handler.BeginInvoke(projectId, projectName, clientPath, string.Empty, action, IAsyncMenthod, null);
        }
        ...
        /// <param name="action"></param>
        public static void ActionLogAsyn(int projectId, string projectName, string clientPath, string actionCode, ActionType action)
        {
            ActionLogHandler handler = new ActionLogHandler(ActionLog);
            Model.UserModel user = Bll.SystemBll.UserInfo;
            handler.BeginInvoke(projectId, projectName, clientPath, actionCode, action, IAsyncMenthod, null);
        }
        ...
        /// <param name="a"></param>
        /// <param name="b"></param>
        public delegate void ActionLogHandler(int projectId, string projectName, string clientPath, string actionCode, ActionType action);
        ...
        public static string GetActionName(ActionType action)
        {
            switch (action)
            {
                ...
                case ActionType.OPENSOFTWARECHEM:
                    return "打开软件CHEM";
        ...
        public static string GetActionName(string actionName)
        {
            switch (actionName)
            {
                ...
                case "打开软件CHEM":
                    return ActionType.OPENSOFTWARECHEM.ToString();
                default:
                    return "特殊操作";
            }
        }
